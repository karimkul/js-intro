...
// We can trimStart and trimEnd then change it to upperCase and slice it last character and change it to loweCase. Output will be "e"
...
// .indexOf("n") returns 0. If it .startsWith("0") and output will be false.
...
var result16 = "ReplaceAll"
    ...
    .toString()
    .trim(); //valid chain
// We can replace  string then use indexof to find .indexOf("ll"). Output will be number 3 and change it to string. Result will be "3"
